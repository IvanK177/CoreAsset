...
export default function RootError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-16 space-y-4">
      <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-destructive/10">
        <AlertTriangle className="w-7 h-7 text-destructive" />
      </div>
      <h2 className="text-xl font-bold">Критическая ошибка</h2>
      ...
      <Button variant="outline" onClick={() => reset()} className="mt-2">Обновить страницу</Button>
    </div>
  );
}