...
export function ITPortalIncidentDetailsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl rounded-2xl p-6 shadow-2xl">
        ...
        <div className="mt-4 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-muted/30 border border-border text-sm">
            ...
            <div className="space-y-1">
              <span className="text-xs font-medium text-muted-foreground block">Отправитель</span>
            ...
            {/* Date Created */}
            <div className="space-y-1">
              <span className="text-xs font-medium text-muted-foreground block">Создана</span>
              <div className="flex items-center gap-1.5 font-medium text-foreground/90">
            ...
            {/* Resolved Date */}
            <div className="space-y-1 pt-2 border-t border-border">
              <span className="text-xs font-medium text-muted-foreground block">Закрыта</span>
              <div className="flex items-center gap-1.5 font-medium text-foreground/90">
